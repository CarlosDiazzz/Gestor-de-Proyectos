<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <nav class="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
            <div>
                <h3 class="mb-4 ml-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Menú Principal</h3>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    @if (Auth::user()->roles->contains('nombre', 'Admin'))
                        ...
                        <li>
                            <a href="{{ route('admin.eventos.index') }}" class="{{ $linkClass }} {{ request()->routeIs('admin.eventos.*') ? $activeClass : '' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                Eventos
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.equipos.index') }}" class="{{ $linkClass }} {{ request()->routeIs('admin.equipos.*') ? $activeClass : '' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                                Equipos
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.proyectos.index') }}" class="{{ $linkClass }} {{ request()->routeIs('admin.proyectos.*') ? $activeClass : '' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                                Proyectos
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.resultados.index') }}" class="{{ $linkClass }} {{ request()->routeIs('admin.resultados.*') ? $activeClass : '' }}">
                    ...
                    @if (Auth::user()->roles->contains('nombre', 'Juez'))
                        <li><p class="mt-4 mb-2 ml-4 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase">Juez</p></li>
                        <li>
                            <a href="{{ route('juez.dashboard') }}" class="{{ $linkClass }} {{ request()->routeIs('juez.dashboard') ? $activeClass : '' }}">
                    ...
                    @if (Auth::user()->roles->contains('nombre', 'Participante'))
                        <li><p class="mt-4 mb-2 ml-4 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase">Participación</p></li>
                        <li>
                            <a href="{{ route('participante.dashboard') }}" class="{{ $linkClass }} {{ request()->routeIs('participante.dashboard') ? $activeClass : '' }}">
