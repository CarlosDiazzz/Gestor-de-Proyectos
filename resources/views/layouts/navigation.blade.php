<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->roles->contains('nombre', 'Juez'))
                        {{-- El juez opera principalmente desde el Dashboard --}}
                    @endif

                    {{-- 4. MENÚ PARTICIPANTE --}}
                    @if (Auth::user()->roles->contains('nombre', 'Participante'))
                        {{-- <x-nav-link :href="route('participante.mi-equipo')">Mi Equipo</x-nav-link> --}}
                    @endif
                </div>
            </div>
    ...
    <script>
        ...
        // 2. Función para establecer el estado visual de los iconos
        ...
        // 3. Inicialización: Verificar preferencia guardada o del sistema
