    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden relative">
                ...
                <div class="p-8">
                    <div class="mb-8">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white">Registrar Evento</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Crea una nueva convocatoria para hackathons o concursos.</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="nombre" name="nombre" type="text" 
                                    ...
                                    :value="old('nombre')" required autofocus placeholder="Ej: Hackathon 2025" />
                            </div>
